...
### Copying Objects
 ```bash
aws s3 cp flights_parquet/flight1.csv s3://developers-test-bucket1/raw/

# Moving entire folder
aws s3 cp s3://developers-test-bucket1/raw/ s3://developers-test-bucket1/raw/flights_parquet/ --recursive 

```

### Moving Objects
 ```bash
aws s3 mv s3://developers-test-bucket1/raw/abc.txt s3://developers-test bucket1/raw/flights_parquet/

# Moving entire folder
aws s3 mv s3://developers-test-bucket1/raw/ s3://developers-test-bucket1/raw/flights_parquet/ --recursive 

# Moving with wild card
aws s3 mv s3://developers-test-bucket1/raw/ s3://developers-test-bucket1/raw/flights_parquet/ --recursive --exclude "*" --include "OP*"
```
